...
@author: Akard3, original filename: ACGT03102013_split.py
placed into function: msl043 6.12.2019 - renamed convert_ms2db_to_fasta.py
to better represent purpose
'''
import os
import sys

def Convert_ms2db(ms2db_file_name, out_file, input_length):
